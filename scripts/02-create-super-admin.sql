...
BEGIN
    ...
    IF NOT user_exists THEN
        ...
        RAISE NOTICE 'Utilisateur super admin créé avec ID: %', user_uuid;
    ELSE
        -- Récupérer l'ID de l'utilisateur existant
        SELECT id INTO user_uuid FROM auth.users WHERE email = 'san@sandigitalsolutions.com';
        RAISE NOTICE 'Utilisateur existant trouvé avec ID: %', user_uuid;
    END IF;
    
    -- Créer le profil dans la table profiles si elle existe
    ...
    -- Créer le profil dans la table users si elle existe
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'user_roles' AND table_schema = 'public') THEN
        ...
        BEGIN
            ...
            IF super_admin_role_id IS NOT NULL THEN
                ...
                RAISE NOTICE 'Rôle super_admin assigné avec ID: %', super_admin_role_id;
            ELSE
    ...
    RAISE NOTICE 'Mot de passe: SuperAdmin2024!';
